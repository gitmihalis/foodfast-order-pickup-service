...
// Client.checkEmailUniqueness('a1@example.com')
...
// Orderitems.create_orderitems(2, 2, 2, 6)
//   .then(() => {})
//   .catch((err) => {
//     console.log(err);
//   });

// Orderitems.create_orderitems(4, 4, 4, 4)
//   .then((result) => {console.log(result)})
//   .catch((err) => {
//     console.log(err);
//   });

Item.find_by_name('Twilio')
  .then((item) => {
    console.log (item);
  })
  .catch((err) => {
